...
/**
 * Represents a single data point in a park usage report. This class
 * encapsulates information about the park's occupancy for a specific day,
...
public class UsageReportData implements Serializable {
	...
	/**
	 * The highest number of visitors present in the park simultaneously on this
	 * day.
	 */
	private int peakOccupancy;

	/**
	 * A flag indicating whether the park reached its maximum capacity at any point
	 * during this day. True if full, false otherwise.
	 */
	 ...
	 * @param full          A boolean indicating if the park reached maximum
	 *                      capacity.
	 */
