...
/**
 * Represents a visitor's order for a park visit in the GoNature system. This
 * entity class holds all the relevant details of an order, including visitor
 * information, timing, status, and automated reminder timestamps. It implements
 * {@link Serializable} so it can be passed between the client and server.
 */
...
public class Order implements Serializable {
	...
	/**
	 * The timestamp until which a spot is held for the visitor (used in waiting
	 * lists).
	 */
	private Timestamp holdUntil;

	/**
	 * The timestamp representing the deadline for the visitor to confirm their
	 * reminder.
	 */
	...
	/**
	 * Constructs a fully detailed Order including both hold and reminder
	 * timestamps.
	 *
	 * @param orderId       The unique order ID.
	 * @param parkId        The ID of the park.
