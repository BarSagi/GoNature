...
public class EmployeeInfoStrategy implements MessageStrategy {
    ...
    public void execute(Message message) {
        ...
        if (employeeData == null || employeeData.isEmpty()) {
            Platform.runLater(() ->
                LoginEmployeeController.instance.showError("Invalid username or password")
            );
            return;
        }
        ...
        GoNatureClient.currentEmployee =
                new Employee(id, firstName, lastName, email, username, role, affiliation);
