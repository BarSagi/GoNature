...
/**
 * Represents a generated report saved as an image file.
 * This entity class encapsulates the report's metadata (such as its type, associated park,
 * and date) along with the actual image data stored as a byte array. 
 * Implements {@link Serializable} to allow the transfer of report images over the network.
 */
public class ReportImage implements Serializable {
	...
	/**
	 * A timestamp string indicating exactly when the report was generated and saved.
	 */
	...
	/**
	 * Constructs a new ReportImage intended for saving to the database.
	 * This constructor omits the reportId and createdAt fields, as they are typically 
	...
	/**
	 * Constructs a ReportImage with all fields populated.
	 * This constructor is typically used when fetching an existing report from the database.
	 *
