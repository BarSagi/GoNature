...
public class ServiceRepresentativeDashboardController {
    ...
    void handleLogout(ActionEvent event) {
        // In a real application, you might also want to clear currentEmployee session data here
        ClientUI.changeScreen("/GUI/LoginRoute.fxml", "GoNature - Choose Role");
    }

    /**
     * Helper method to dynamically load and switch FXML sub-panels inside the contentArea
